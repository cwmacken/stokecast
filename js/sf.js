...
jQuery(document).ready(function($) {
  		$.ajax({
  		url : "http://api.wunderground.com/api/5a639e6ef7ecb1a6/geolookup/conditions/q/CA/San_Francisco.json",
  		dataType : "jsonp",
	...
	jQuery(document).ready(function($) {
  		$.ajax({
  		url : "http://api.wunderground.com/api/5a639e6ef7ecb1a6/tide/q/CA/San_Francisco.json",
  		dataType : "jsonp",
  		success : function(response) {
  			console.log(response);
