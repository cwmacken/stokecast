...
jQuery(document).ready(function($) {
  		$.ajax({
  		url : "http://api.wunderground.com/api/5a639e6ef7ecb1a6/geolookup/conditions/q/CA/bodega_bay.json",
  		dataType : "jsonp",
	...
	jQuery(document).ready(function($) {
  		$.ajax({
  		url : "http://api.wunderground.com/api/5a639e6ef7ecb1a6/tide/q/CA/bodega_bay.json",
  		dataType : "jsonp",
  		success : function(response) {
  			console.log(response);
